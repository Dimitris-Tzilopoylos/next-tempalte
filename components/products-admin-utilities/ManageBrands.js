...
import { 
    ...
    updateCategory,
    deleteCategory,
    createCategory } from '../../store/actions/products'
...
export const ManageBrands = (props) => {
...
const mapDispatchToProps = {getSupercategories,getCategories,createCategory,updateCategory,deleteCategory}
